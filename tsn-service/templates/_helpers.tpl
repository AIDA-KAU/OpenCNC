...
{{/*
tsn-service consensus image name
*/}}
{{- define "tsn-service.store.consensus.imagename" -}}
...
{{/*
tsn-service consensus store name
*/}}
{{- define "tsn-service.store.consensus.name" -}}
{{- if .Values.store.consensus.name -}}
{{- printf "%s" .Values.store.consensus.name -}}
{{- else -}}
{{- printf "%s-consensus-store" ( include "tsn-service.fullname" . ) -}}
{{- end -}}
{{- end -}}
